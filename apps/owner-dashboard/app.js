...
function openAgent(agent) {
  ...
  openDrawer([
    ...
    detailSection("Authority", [
      ...
      ]):node("p",{class:"safety-note",text:"This capability has expired. Create a replacement agent to issue fresh access."}),
    ]),
